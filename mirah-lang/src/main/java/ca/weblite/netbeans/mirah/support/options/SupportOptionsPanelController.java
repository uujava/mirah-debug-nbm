...
package ca.weblite.netbeans.mirah.support.options;

import java.beans.PropertyChangeListener;
import java.beans.PropertyChangeSupport;
import java.util.Collection;
import javax.swing.JComponent;
import ca.weblite.netbeans.mirah.support.spi.MirahOptionsSubpanel;
...
public final class SupportOptionsPanelController extends OptionsPanelController {
    ...
    private SupportPanel getPanel() {
        if (panel == null) {
            Collection<? extends MirahOptionsSubpanel> subpanels = Lookup.getDefault().lookupAll(MirahOptionsSubpanel.class);
