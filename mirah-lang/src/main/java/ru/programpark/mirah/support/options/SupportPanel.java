...
import ru.programpark.mirah.support.api.MirahSettings;
...
final class SupportPanel extends javax.swing.JPanel {
    ...
    SupportPanel(@NonNull Collection<? extends MirahOptionsSubpanel> subpanels) {

        this.subpanels = new ArrayList<MirahOptionsSubpanel>(subpanels);
        initComponents();

        int y = 1;
        for (MirahOptionsSubpanel subpanel: this.subpanels) {
    ...
    private void initComponents() {
        ...
        mirahDocTextField = new javax.swing.JTextField();
        ...
        docLabel.setLabelFor(mirahDocTextField);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(mirahDocTextField)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(chooseDocButton)
                    .addComponent(mirahDocTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(subpanelWrapper, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE))
        );

        mirahDocTextField.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(SupportPanel.class, "SupportPanel.groovyDocTextField.accessibleName")); // NOI18N
        mirahDocTextField.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(SupportPanel.class, "SupportPanel.groovyDocTextField.accessibleDescription")); // NOI18N
...
private void chooseDocButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseDocButtonActionPerformed
    File file = new FileChooserBuilder(SupportPanel.class)
            ...
            .showOpenDialog();
    if (file != null) {
        if (!new File(new File(file, "mirah-jdk"), "index.html").isFile()) {
            DialogDisplayer.getDefault().notify(new NotifyDescriptor.Message(
                NbBundle.getMessage(SupportPanel.class, "LBL_Not_mirah_doc"),
                NotifyDescriptor.Message.WARNING_MESSAGE));
            return;
        }
        mirahDocTextField.setText(file.getAbsolutePath());
    }
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
        try {
            HtmlBrowser.URLDisplayer.getDefault().showURL(new URL("http://www.mirah.org")); // NOI18N
    ...
    void load() {
        MirahSettings mirahOption = MirahSettings.getInstance();
        String text = mirahOption.getMirahDoc();
        if (text == null) {
            text = "";
        }
        mirahDocTextField.setText(text);
    ...
    void store() {
        MirahSettings mirahOption = MirahSettings.getInstance();
        mirahOption.setMirahDoc(mirahDocTextField.getText().trim());
    ...
    boolean valid() {
        String mirahDoc = mirahDocTextField.getText().trim();
        if ("".equals(mirahDoc)) {
            return false;
        }
        for (MirahOptionsSubpanel subpanel: this.subpanels) {
    ...
    boolean changed() {
        String text = MirahSettings.getInstance().getMirahDoc();
        if (text == null) {
            text = "";
        }
        if (!text.equals(mirahDocTextField.getText().trim())) {
            return true;
        }
    ...
    private javax.swing.JTextField mirahDocTextField;
