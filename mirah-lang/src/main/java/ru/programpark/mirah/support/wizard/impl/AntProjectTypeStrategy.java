...
import ru.programpark.mirah.support.wizard.JUnit;
import ru.programpark.mirah.support.wizard.ProjectTypeStrategy;
...
public class AntProjectTypeStrategy extends ProjectTypeStrategy {
    ...
    @Override
    public boolean existsMirahTestFolder(List<SourceGroup> groups) {
        return existsFolder(groups, "test"); // NOI18N
    }

    @Override
    public boolean existsMirahSourceFolder(List<SourceGroup> groups) {
    ...
    @Override
    public void createMirahTestFolder() {
        createFolder(project.getProjectDirectory(), "test"); // NOI18N
    }

    @Override
    public void createMirahSourceFolder() {
