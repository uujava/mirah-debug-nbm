...
package ru.programpark.mirah.support.wizard;
...
/**
 * Base project type strategy implementation used by MirahJUnitTestWizardIterator.
...
public abstract class ProjectTypeStrategy {
    ...
    public abstract boolean existsMirahTestFolder(List<SourceGroup> groups);

    public abstract boolean existsMirahSourceFolder(List<SourceGroup> groups);

    public abstract void createMirahTestFolder();

    public abstract void createMirahSourceFolder();
     ...
     * @return Mirah JUnit Test template based on JUnit version declared in pom.xml
     */
