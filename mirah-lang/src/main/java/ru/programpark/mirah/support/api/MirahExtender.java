...
/**
 * An API providing ability to activate Mirah support in specified {@link Project}.
 * <p>
 * Client can use this interface to activate/deactivate Mirah support or to
 * find out if the support is already active for a certain {@link Project}.
 *
 * @author Martin Janicek <mjanicek@netbeans.org>
 *
 * @see MirahExtenderImplementation
 * @since 1.31
 */
public final class MirahExtender {
    ...
    /**
     * Check if the Mirah support had been already activated for the given {@link Project}.
     *
    ...
    /**
     * Deactivates Mirah support for the given {@link Project}.
     *
     * @param project project
