...
public abstract class IndexedElement extends MirahElement {
...
//    @Override
    ...
    public boolean isPublic() {
        return true; //(flags & Opcodes.ACC_PUBLIC) != 0;
    }

    public boolean isPrivate() {
        return false; //(flags & Opcodes.ACC_PRIVATE) != 0;
    }

    public boolean isProtected() {
        return false; //(flags & Opcodes.ACC_PROTECTED) != 0;
    }

    public boolean isStatic() {
        return false; //(flags & Opcodes.ACC_STATIC) != 0;
    }
