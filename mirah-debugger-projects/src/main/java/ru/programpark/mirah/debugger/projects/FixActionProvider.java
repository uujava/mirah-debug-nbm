...
//        LOG.info("getCurrentProject");
        Node[] nodes = TopComponent.getRegistry ().getActivatedNodes ();
//        LOG.info("getCurrentProject NODES="+nodes);
...
//        LOG.info("getCurrentProject dao="+dao);
        if (dao == null) return MainProjectManager.getDefault().getMainProject();
//        LOG.info("getCurrentProject dao.getPrimaryFile()="+dao.getPrimaryFile());
//        LOG.info("getCurrentProject --> "+FileOwnerQuery.getOwner(dao.getPrimaryFile()));
