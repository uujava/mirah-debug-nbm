...
package ru.programpark.mirah.debugger.breakpoints;

import java.awt.Dimension;

import org.netbeans.api.debugger.Breakpoint.HIT_COUNT_FILTERING_STYLE;

import ru.programpark.mirah.debugger.FilteredKeymap;
import ru.programpark.mirah.debugger.WatchPanel;
...
public class ConditionsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tfCondition.setContentType("text/x-vruby"); // NOI18N
